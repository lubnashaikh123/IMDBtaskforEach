...
let Moviearray=[
 ...
 const Lubna = document.getElementById("movie");
 let result ="";
 Moviearray.forEach(function(array){
	result+=`
	       <div class="col-md-3 mb-4">
				<div class="card">
					<figure class="movieContainer">
						<img class="img-fluid" src="https://image.tmdb.org/t/p/w1280/${array.poster_path}">
					<figcaption>
						<div class="heading">
							<div class="row">
								<div class="col-sm-9">
